...
public class Luban implements Handler.Callback {
  protected static final String TAG = "Luban";
  protected static final String DEFAULT_DISK_CACHE_DIR = "luban_disk_cache";

  protected static final int MSG_COMPRESS_SUCCESS = 0;
  protected static final int MSG_COMPRESS_START = 1;
  protected static final int MSG_COMPRESS_ERROR = 2;

  protected String mTargetDir;
  protected int mLeastCompressSize;
  protected OnRenameListener mRenameListener;
  protected OnCompressListener mCompressListener;
  protected CompressionPredicate mCompressionPredicate;
  protected List<InputStreamProvider> mStreamProviders;
   ...
   */
  protected File getImageCacheFile(Context context, String suffix) {
  ...
  protected File getImageCustomFile(Context context, String filename) {
    if (TextUtils.isEmpty(mTargetDir)) {
      mTargetDir = getImageCacheDir(context).getAbsolutePath();
    }
   ...
   */
  @Nullable
  protected File getImageCacheDir(Context context) {
   ...
   */
  @Nullable
  protected static File getImageCacheDir(Context context, String cacheName) {
  ...
  public static class Builder {
    ...
    protected String mTargetDir;
    protected int mLeastCompressSize = 100;
    protected OnRenameListener mRenameListener;
    protected OnCompressListener mCompressListener;
    protected CompressionPredicate mCompressionPredicate;
    protected List<InputStreamProvider> mStreamProviders;
