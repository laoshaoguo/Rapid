...
public class MediaStoreHelper {
  ...
  public final static int LOADER_ALBUM_LIST = 1;
  public final static int LOADER_ALBUM_DETAIL = 2;


  public static void getPhotoDirs(FragmentActivity activity, Bundle args, int loaderTag, PhotosResultCallback resultCallback) {
    LoaderManager.getInstance(activity)
            .initLoader(loaderTag, args, new PhotoDirLoaderCallbacks(activity, resultCallback));
  }

  public static void destroyLoader(FragmentActivity activity,int tag){
    LoaderManager.getInstance(activity).destroyLoader(tag);
  }
