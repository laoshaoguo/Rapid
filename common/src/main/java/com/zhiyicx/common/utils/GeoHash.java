...
public class GeoHash {
    ...
    private static class Singleton {
        protected static GeoHash singleton = new GeoHash();
    }
    ...
    public GeoHash setLocation(LocationBean location){
    ...
    private GeoHash(double lat, double lng) {
