...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    private BitmapIntercepte mBitmapIntercepte;

    // 拦截器
    public interface BitmapIntercepte {
    ...
    public RoundedCornersTransformation(Context context, int radius,
                                        int margin, CornerType cornerType,BitmapIntercepte bitmapIntercepte) {
        super(context);
        this.radius = radius;
        this.diameter = this.radius * 2;
        this.margin = margin;
        this.cornerType = cornerType;
        this.mBitmapIntercepte = bitmapIntercepte;
    }

    @Override
    protected Bitmap transform(BitmapPool pool, Bitmap toTransform, int outWidth, int outHeight) {
        if (mBitmapIntercepte != null) {
            mBitmapIntercepte.bitmap(toTransform);
        }
